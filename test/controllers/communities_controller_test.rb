...
class CommunitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create community" do
    assert_difference("Community.count") do
      post communities_url, params: { community: { body: @community.body, link: @community.link, title: @community.title } }
    end
  ...
  test "should update community" do
    patch community_url(@community), params: { community: { body: @community.body, link: @community.link, title: @community.title } }
