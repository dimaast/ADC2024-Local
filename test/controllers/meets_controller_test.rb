...
class MeetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meet" do
    assert_difference("Meet.count") do
      post meets_url, params: { meet: { body: @meet.body, date_hosted: @meet.date_hosted, geotag: @meet.geotag, user_id: @meet.user_id } }
    end
  ...
  test "should update meet" do
    patch meet_url(@meet), params: { meet: { body: @meet.body, date_hosted: @meet.date_hosted, geotag: @meet.geotag, user_id: @meet.user_id } }
