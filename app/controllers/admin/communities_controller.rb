class Admin::CommunitiesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_communities_path, status: :see_other, notice: "Community was successfully destroyed." }
  ...
  private
    ...
    def community_params
      params.require(:community).permit(:title, :link, :body)
    end
end
